...
namespace Pagame
{
    public partial class Global : System.Web.HttpApplication
    {
        ...
        static string _AppCredits, _AppName = "Social Office Pagame";
        static public string AppComercialName = "Social Office Pagame";
        ...
        private void Session_Start( object sender, EventArgs e )
        {
            ...
            LogDebug( null, EnumLogCategories.CONFIGURATION, "Session Started, ID: " + Session.SessionID + " IP: " + Context.Request.UserHostAddress.ToString() );
